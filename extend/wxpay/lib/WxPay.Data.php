 ...
 *
 */
class WxTransOrder extends WxPayDataBase
{
    /**
     * 设置 商户账号appid
     * @param string $value
    ...
    public function SetMch_id($value)
    {
        return $this->values['mchid'] = $value;
    }
    ...
    /**
     * 设置 校验用户姓名选项  NO_CHECK：不校验真实姓名  FORCE_CHECK：强校验真实姓名
     * @param string $value
     **/
    ...
    /**
     * 设置 收款用户姓名 收款用户真实姓名。如果check_name设置为FORCE_CHECK，则必填用户真实姓名
     * @param string $value
     **/
    ...
    /**
     * 设置  Ip地址 该IP同在商户平台设置的IP白名单中的IP没有关联，该IP可传用户端或者服务端的IP。
     * @param string $value
     **/
    public function SetSpbill_create_ip($value)
    {
