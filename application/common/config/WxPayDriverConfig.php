...
class WxPayDriverConfig extends WxPayConfigInterface
{
    ...
    {
        return 'X21M52zZks4mfxRcjD85M9M5UUPRhm3s';
    }
    ...
    {
        $sslCertPath = ROOT_PATH . 'extend/wxpay/cert/apiclient_cert.pem';
        $sslKeyPath  = ROOT_PATH . 'extend/wxpay/cert/apiclient_key.pem';
    }
}
